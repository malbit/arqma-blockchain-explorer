...
set(LIBS common;cryptonote_basic;cryptonote_core;multisig;
    ...
    set(ARQ_INCLUDE_DIRS "${CPP_ARQMA_DIR}")
...
foreach (l ${LIBS})
	...
	set(ARQ_${L}_LIBRARIES ${ARQ_${L}_LIBRARY})

    message(STATUS FindArqma " ARQ_${L}_LIBRARIES ${ARQ_${L}_LIBRARY}")

	add_library(${l} STATIC IMPORTED)
	set_property(TARGET ${l} PROPERTY IMPORTED_LOCATION ${ARQ_${L}_LIBRARIES})
